        ...
        <div className="site-page">
            <div className="site-inner">
                ...
                <div className="form-panel legal-page">
                    ...
                    <p>By signing up for Shabbat Alert, you agree to receive recurring SMS messages about Shabbat and Jewish holiday candle-lighting times based on the location and preferences you provide.</p>
                    ...
                    <h3>Accuracy</h3>
                    <p>Candle-lighting times are sourced from Hebcal and depend on your saved location. Update your city if you travel.</p>
