        ...
        <div className="site-page">
            <div className="site-inner signup-page">
                ...
                <div className="form-panel legal-page">
                    ...
                    <p>
                        Shabbat Alert sends SMS reminders before Shabbat candle lighting.
                    ...
                    <ul className="legal-list">
                        ...
                        <li>City and state (to look up candle-lighting times for your area)</li>
                        <li>Alert preferences (how many minutes before candle lighting to notify you)</li>
                    </ul>

                    <h3>How we use it</h3>
                    <p>
                        Your data is used only to send the Shabbat SMS alerts you signed up for.
                        We do not sell or share your information with third parties for marketing.
                    </p>

                    <h3>SMS messaging</h3>
                    <p>
                        We send weekly Shabbat reminder texts. Message and data rates may apply.
